...
const Page = () => {
    ...
    return (
        <div className="w-[60%] max-w-[800px] min-w-[700px] min-h-[1000px] mx-auto flex flex-col justify-start border-solid gap-4 border-2 shadow-lg rounded-xl p-4">
            <div className="w-[95%] mb-10 h-[400px] mx-auto border-solid border-blue-400 border-opacity-65 shadow-blue-500 gap-4 border-2 shadow-md rounded-xl hover:scale-105 relative">
                <div className="m-5">
                    ...
                    <div className="flex">
                        ...
                        <Label className="text-md">{user?.age}</Label>
                        <Label className="text-md">{user?.gender}</Label>
                        <Label className="text-md">{user?.address}</Label>
                        </div>
                    </div>
                    <div className="ml-auto items-center">
                        <Button onClick={()=> router.push('/auth/update-account')
                        }> 
                        Sửa
                        </Button>
                    </div>
            ...
            <div className="w-[95%] min-h-[300px] mx-auto flex items-center justify-center border-solid border-green-400 border-opacity-65 shadow-green-500 gap-4 border-2 shadow-md rounded-xl hover:scale-105">
            {/* Nội dung khác */}
            </div>
        </div>
